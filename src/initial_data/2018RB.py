...
for pp in qq.as_aggregate():
  RBs['Saquon Barkley'] = {"name": 'Saquon Barkley', "rushing_yds": pp.rushing_yds, "rushing_att": pp.rushing_att, "rushing_tds": pp.rushing_tds}
...
for pp in q.sort('rushing_yds').limit(49).as_aggregate():
  RBs[pp.player.full_name] = {"name": pp.player.full_name, "rushing_yds": pp.rushing_yds, "rushing_att": pp.rushing_att, "rushing_tds": pp.rushing_tds}
